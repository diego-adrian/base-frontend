// curl -X POST https://account-idetest.agetic.gob.bo/reg -H "Content-Type: application/json" -d '{"redirect_uris": ["http://localhost:8080/oauth/login.html"], "post_logout_redirect_uris":["http://localhost:8080/oauth/logout.html"],"client_name":"frontend_base_vue","token_endpoint_auth_method":"client_secret_basic","authorization_params":{"scope":"openid nombre email documento_identidad fecha_nacimiento celular"},"grant_types":["authorization_code"],"response_types":["code"],"application_type":"web","contacts":["dbarra@agetic.gob.bo"]}'
const openId = {
